 ...
 */
final class Version20210930082834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE statistic ADD beer_id INT DEFAULT NULL, ADD client_id INT DEFAULT NULL, DROP beer_id_id, DROP client_id_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE statistic ADD beer_id_id INT DEFAULT NULL, ADD client_id_id INT DEFAULT NULL, DROP beer_id, DROP client_id');
        $this->addSql('ALTER TABLE statistic ADD CONSTRAINT FK_649B469C872EC465 FOREIGN KEY (beer_id_id) REFERENCES beer (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE statistic ADD CONSTRAINT FK_649B469CDC2902E0 FOREIGN KEY (client_id_id) REFERENCES client (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
